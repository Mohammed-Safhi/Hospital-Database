...
CREATE TABLE `phonenum` (
  ...
  CONSTRAINT `PatientID` FOREIGN KEY (`PatientID`) REFERENCES `patients` (`P-ID`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `phonenum` VALUES (590506022,3330),(590506051,3330),(590506052,3330),(530503322,3334),(540506033,3335),(590544055,3336),(540355051,3337),(560436099,3338),(540506042,3339);
